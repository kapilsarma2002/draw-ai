import { elementLinkIcon } from '@excalidraw/excalidraw/components/icons'
import { tool } from 'ai'
import z from 'zod'

export const tools = {
  generateDiagram: tool({
    description: 'Generate a complete diagram as an array of Excalidraw elements. Use this when user asks you to create, draw or design a new diagram. Return all elements including shapes, text labels and arrow lines connecting them',
